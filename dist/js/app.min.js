...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @splidejs/splide */ \"./node_modules/@splidejs/splide/dist/js/splide.esm.js\");\n/* harmony import */ var fslightbox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! fslightbox */ \"./node_modules/fslightbox/index.js\");\n\r\n\r\n\r\n\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n\r\nconst burgerBtn = document.querySelector('.burger__btn');\r\nburgerBtn.addEventListener('click', _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.toggleMobileMenu);\r\n\r\nlet topSliderImg, topSliderTitle;\r\n\r\nif (document.querySelector('.top__slider-img') != null && document.querySelector('.top__slider-title') != null) {\r\n  topSliderImg = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__.Splide('.top__slider-img', {\r\n    type: 'fade',\r\n    height: '550px',\r\n    rewind: true,\r\n    speed: 400,\r\n    autoplay: true,\r\n    pauseOnFocus: true,\r\n    pauseOnHover: true,\r\n    breakpoints: {\r\n      767: {\r\n        destroy: true,\r\n      },\r\n    },\r\n  });\r\n\r\n  topSliderTitle = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__.Splide('.top__slider-title', {\r\n    type: 'fade',\r\n    rewind: true,\r\n    speed: 400,\r\n    width: '100%',\r\n    autoplay: true,\r\n    autoHeight: true,\r\n    arrows: false,\r\n    pagination: false,\r\n    pauseOnFocus: true,\r\n    pauseOnHover: true,\r\n    breakpoints: {\r\n      767: {\r\n        arrows: true,\r\n      },\r\n    },\r\n  });\r\n\r\n  topSliderTitle.sync(topSliderImg);\r\n  topSliderTitle.mount();\r\n  topSliderImg.mount();\r\n}\r\n\r\nif (document.querySelector('.top__tabs-btn') != null) {\r\n  _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.tabs('top__tabs-btn', 'top__tabs-item', 'active');\r\n}\r\n\r\nconst category = document.querySelector('#category');\r\nconst calcCategories = document.querySelectorAll('#category ~ .form__category');\r\nconst filmType = document.querySelector('#film-type');\r\nconst calcFilmTypes = document.querySelectorAll('.form__film-type');\r\n\r\nif (category != null) {\r\n  category.addEventListener('change', () => {\r\n    _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.unbindModal('.open-modal-calc', '.form--calc');\r\n    _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.bindModal('.open-modal-calc', `.modal--${category.value}`, '.modal__close');\r\n  });\r\n}\r\n\r\nlet equipSlider;\r\nif (document.querySelector('.equip__slider') != null) {\r\n  equipSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__.Splide('.equip__slider', {\r\n    type: 'fade',\r\n    rewind: true,\r\n    speed: 400,\r\n    width: 780,\r\n    autoplay: true,\r\n    autoHeight: true,\r\n    arrows: true,\r\n    pagination: false,\r\n    pauseOnFocus: true,\r\n    pauseOnHover: true,\r\n  });\r\n  equipSlider.mount();\r\n}\r\n\r\nlet productSlider;\r\nlet productThumbs;\r\nif (document.querySelector('.product__main-image') != null && document.querySelector('.product__thumbs') != null) {\r\n  productSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__.Splide('.product__main-image', {\r\n    fixedWidth: 380,\r\n    fixedHeight: 300,\r\n    type: 'fade',\r\n    rewind: true,\r\n    pagination: false,\r\n    arrows: false,\r\n    breakpoints: {\r\n      767: {\r\n        fixedWidth: 280,\r\n        fixedHeight: 150,\r\n      },\r\n    },\r\n  });\r\n\r\n  productThumbs = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__.Splide('.product__thumbs', {\r\n    fixedWidth: 100,\r\n    fixedHeight: 80,\r\n    cover: true,\r\n    gap: 10,\r\n    perPage: 3,\r\n    rewind: false,\r\n    pagination: false,\r\n    isNavigation: true,\r\n    breakpoints: {\r\n      767: {\r\n        fixedWidth: 70,\r\n        fixedHeight: 50,\r\n      },\r\n    },\r\n  });\r\n\r\n  productSlider.sync(productThumbs);\r\n  productSlider.mount();\r\n  productThumbs.mount();\r\n}\r\n\r\nif (document.querySelector('.product__tabs-btn') != null) {\r\n  _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.tabs('product__tabs-btn', 'product__tabs-item', 'active');\r\n}\r\n\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.accordion();\r\n\r\nlet filmOptions = [];\r\n\r\nif (document.querySelector('.form--calc-film-price') != null) {\r\n  const form = document.querySelector('.form--calc-film-price');\r\n  filmOptions = _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.calcPrice();\r\n  const orderModal = document.querySelector('.form--order-modal');\r\n  const inputWidth = document.createElement('input');\r\n  inputWidth.type = 'hidden';\r\n  inputWidth.name = 'width';\r\n  inputWidth.value = filmOptions[0];\r\n  orderModal.insertBefore(inputWidth, orderModal.firstChild);\r\n  const inputLength = document.createElement('input');\r\n  inputLength.type = 'hidden';\r\n  inputLength.name = 'length';\r\n  inputLength.value = filmOptions[1];\r\n  orderModal.insertBefore(inputLength, orderModal.firstChild);\r\n  form.addEventListener('change', () => {\r\n    filmOptions = _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.calcPrice();\r\n    inputWidth.value = filmOptions[0];\r\n    inputLength.value = filmOptions[1];\r\n  });\r\n}\r\n\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.bindModal('.open-modal-callback', '.modal--callback', '.modal__close');\r\n\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.bindModal('.open-modal-order', '.modal--order', '.modal__close');\r\n\n\n//# sourceURL=webpack://gulp2022/./src/js/app.js?");
